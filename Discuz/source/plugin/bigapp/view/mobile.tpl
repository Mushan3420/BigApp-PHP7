...
<head>
  ...
  <style>
    body, div, dl, dt, dd, ul, ol, li, h1, h2, h3, h4, h5, h6, pre, code, form, fieldset, legend, label, input, textarea, p, blockquote, th, td, hr, button, article, aside, details, figcaption, figure, footer, header, menu, nav, section, i, span, a { margin:0; padding:0; border:none;  }
        ...
        #container{ width: 100%; min-height:100px; position: relative; background: url(<%plugin_path%>/static/bg.jpg) center 0 no-repeat; }
        #content{ overflow: hidden; width: 980px; margin: 0 auto; position: relative;}
        .frame-l{ float: left; width: 498px; overflow: hidden;}
        .frame-l .phone-show{ margin-left: 2px; width: 419px; height: 625px; background: url(<%plugin_path%>/static/phone.png); margin-top: 45px; overflow: hidden;}
        ...
        .link-bar .btn-ios{ background-image: url(<%plugin_path%>/static/icon-ios.png);}
        .link-bar .btn-android{ background-image: url(<%plugin_path%>/static/icon-android.png);}
...
<body id="uz">
  <div id="container">
    ...
    <div class="footer">&nbsp;
        <div class="copyright">Copyright &copy; BigApp 2015</div>
    </div>
  </div>  
</body>
</html>
