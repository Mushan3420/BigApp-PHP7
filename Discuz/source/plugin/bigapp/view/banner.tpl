<div id="uz">
    ...
    <script>
        ...
        var pageType = {
            key : 'uploadBanner',
            value : 'banner_image_s',
            imgSize: ['banner_image_s','banner_image_s','banner_image_s']
        };
        var mType = {
            get : 'getBanner',
            set : 'setBanner'
        ...
        <table class="tb tb2 ">
            ...
            <tr class="noborder">
                <td class="vtop rowform">
                    <img src="<%plugin_path%>/image/custom/set_banner_1.png"/>
                </td>
            </tr>
        </table>
        <table class="tb tb2 ">
            <tr>
                <th colspan="15" class="partition">门户区设置</th>
            </tr>
